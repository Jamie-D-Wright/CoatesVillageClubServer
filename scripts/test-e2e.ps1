# Start Service and Run E2E Tests
# This script starts the membership service and runs E2E tests
...
Write-Host "  Membership Service E2E Test Runner" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
